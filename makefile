project1:main.o avl.o entry.o hashtable.o utility.o
	g++ -o project1 -std=c++11 main.o avl.o entry.o hashtable.o utility.o -g3
...
clean:
	rm project1 main.o avl.o entry.o hashtable.o test_main.o utility.o avl_test